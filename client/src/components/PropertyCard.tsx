      ...
      <Link href={`/property/${property.id}`}>
        <a className="block">
          <div className="relative">
            ...
            />
            <button 
              className={`absolute top-3 right-3 bg-white p-2 rounded-full shadow-md ${isFavorite ? 'text-primary' : 'text-neutral-500 hover:text-primary'} transition`}
          ...
          <CardContent className="p-4">
            ...
            <h4 className="font-medium text-neutral-800 mb-1">{property.title}</h4>
            <p className="text-sm text-neutral-500 mb-3">
              <i className="fas fa-map-marker-alt mr-1"></i> {property.location}
            </p>
            
            <div className="flex items-center justify-between text-sm text-neutral-600 mb-4">
              <div><i className="fas fa-bed mr-1"></i> {property.bedrooms} {translate("beds", language)}</div>
              <div><i className="fas fa-bath mr-1"></i> {property.bathrooms} {translate("baths", language)}</div>
              <div><i className="fas fa-vector-square mr-1"></i> {property.area} {translate("sqm", language)}</div>
            </div>
